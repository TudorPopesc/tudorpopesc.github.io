  ...
  <section class="menu">
    ...
    <div class="content-menu" id="cont">
      <div class="link">
        ...
        <div class="link-ref">
          <a class="link-1" href="html/vopros.php">Вопросы</a>
        </div> <br>
        <div class="link-ref">
      ...
      <div class="row">
        ...
        <div class="col-xl-7 col-lg-7  offset-lg-1 col-md-9 ">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="html/vopros.php">Вопросы</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <ul class="list-style">
          ...
          <li>
            <p>Бесплатная доставка и установка </p>
          </li>
        </ul>
      </div>
